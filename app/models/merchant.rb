class Merchant < ApplicationRecord
  ...
  def total_revenue_for_merchant(invoice)
    self.invoice_items.where('invoice_items.invoice_id = ?', invoice.id).sum("invoice_items.unit_price * invoice_items.quantity")
  end
